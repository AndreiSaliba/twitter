...
export default function Input({ style, type, placeholder, className }: props) {
    ...
    switch (style) {
        case "floating":
            return (
                <div
                    className={`relative z-0 box-border flex w-80 rounded-[0.2rem] p-2 pt-6 shadow-[0_0_0_1px_#333639] focus-within:shadow-[0_0_0_2px] focus-within:shadow-blue light:shadow-[#dadce0] light:focus-within:border-blue ${className}`}
                >
                    <input
                        id="floating"
                    ...
                    <label
                        htmlFor="floating"
                        className="absolute top-3.5 -z-10 origin-[0] -translate-y-6 transform text-[#71767b] duration-150 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-3 peer-focus:scale-80 peer-focus:text-blue"
                    >
                        {placeholder}
                    </label>
