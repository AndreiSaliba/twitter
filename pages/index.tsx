...
export default function Home() {
    ...
    return (
        <div className="flex justify-center w-screen h-screen default-style">
            <div className="mt-32 xs:mt-16 flex flex-col items-center">
                <span className="flex flex-row xs:flex-col xs:w-80 items-center justify-center mb-8 w-fit h-fit">
                    <svg viewBox="0 0 24 24" className="mt-1 mr-4 w-9 xs:w-12 xs:mb-8">
                        <path
                    ...
                    <span className="text-[2.25rem] font-black align-top">
                        Join Twitter Today.
                    </span>
                </span>
