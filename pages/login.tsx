...
<button className="mt-5 mb-5 w-80 rounded-full border bg-white p-1.5 hover:bg-[hsl(0,0%,95%)] light:border-[#dadce0] light:bg-[#0f1419] light:hover:bg-[#272c30]">
    <span className="font-semibold text-black light:text-white">
        Log In
    </span>
</button>

<button className="mb-10 w-80 rounded-full border border-[#536471] p-1.5 hover:bg-[#181919] light:border-[#dadce0] light:hover:bg-[#e6e7e7]">
